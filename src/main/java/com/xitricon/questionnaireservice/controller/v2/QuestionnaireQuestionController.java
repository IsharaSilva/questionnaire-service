...
public class QuestionnaireQuestionController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<QuestionnaireOutputDTO> updateQuestionnaire(@RequestParam String tenantId,
			@PathVariable String id, @RequestBody QuestionnaireUpdateInputDTO questionnaireQuestionInput) {
		return ResponseEntity
				.ok(this.questionnaireQuestionService.updateQuestionnaire(tenantId, id, questionnaireQuestionInput));
	}

	@PutMapping("/{id}/questions")
	public ResponseEntity<QuestionnaireOutputDTO> updateQuestionnaireQuestions(@RequestParam String tenantId,
