...
public class QuestionServiceOutputDTO {
    ...
    public QuestionServiceOutputDTO(@JsonProperty("id") String id, @JsonProperty("title") String title, @JsonProperty("type") QuestionType type, @JsonProperty("validations") List<Map<String, String>> validations) {
        this.id = id;
        this.title = title;
        this.type = type;
